...
def main():
    ...
    if x > 98 and x<281  and y>336 and y<394:
        ...
        backgroundcomandos = Image(Point(400,300),"comandos.png")                         # CRIA CENÁRIO
        backgroundcomandos.draw(comandos)
        comand = Text(Point(400,300),"COMANDOS:\nAS SETAS INDICAM A DIREÇÃO EM QUE O CHORIS IRÁ SE MOVER\nE A LETRA 's' EM CASO DE MOVIMENTAÇÃO INDEVIDA\n ")  #COMANDOS
        comand.setSize(15)
        comand.draw(comandos)
        check2 = comandos.getMouse()
        a = check2.getX()
        b = check2.getY()
        if a>302 and a<493  and b>431 and b<498 :
    ...
    if jogar == True:
        ...
        while end!=True:
            ...
            distancia2 = sqrt((xA-xB)**2) + ((yA-yB)**2)
            ...
            distancia3 = sqrt((xA-xB)**2) + ((yA-yB)**2)
        
            somaDosRaios3 = sqrt((xA-xB)**2) + ((yA-yB)**2)
            ...
            distancia4 = sqrt((xA-xB)**2) + ((yA-yB)**2)
            ...
            distancia5 = sqrt((xA-xB)**2) + ((yA-yB)**2)
            ...
            distancia6 = sqrt((xA-xB)**2) + ((yA-yB)**2)
            ...
            if colisao == False:
                ...
                if pontos > 150:
                    velocidade += Bibliotecac.aumentovelo(velocidade)
                    velocidade2 += Bibliotecac.aumentovelo(velocidade2)
                    velocidade3 += Bibliotecac.aumentovelo(velocidade3)
                    velcenario += Bibliotecac.aumentovelocen(velcenario)
            ...
            def movimenta():   # FUNÇÃO DE MOVIMENTAÇÃO
                ...
                if len(tecla1)>0 and "Left" in tecla1:
                    ...
                    choris.move(-5,0)
                    boxchoris.move(-5,0)
                if choris.getAnchor().getX() - 20 <= 20:
                    choris.move(20,0)
                    boxchoris.move(20,0)
                    esquerda = False
